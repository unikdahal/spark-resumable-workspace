...
CP="$HERE/target/classes:$(cat "$WORK/harness-cp.txt"):$CELEBORN_DIR/client-spark/common/target/classes:$CELEBORN_DIR/client-spark/spark-3/target/classes:$CELEBORN_DIR/client/target/classes:$CELEBORN_DIR/common/target/classes"

...
Measured microbenchmarks for envelope encode/decode and batched loads are generated by
`verification/run-c9-benchmark.sh`; see `sql/core/benchmarks/RecoveryTaskCommitBenchmark-results.txt`
once present.
